...
def popularity_score(info):
    ...
    return (
        min(views / 10_000_000, 1)
        * 0.65
        +
        min(likes / 500_000, 1)
        * 0.25
        +
        min(comments / 100_000, 1)
        * 0.10
    )
